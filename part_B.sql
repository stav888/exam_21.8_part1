...
VALUES ('TV1', 'Xiaomi', 'SQ32CR', 65, 'Full HD', 1199.99, 7, 2022, TRUE, 'MI', 'QLED');

INSERT INTO televisions (catalog_number, brand, model, screen_size, resolution, price, stock_quantity, release_year, smart_tv, os, panel_type)
VALUES ('TV2', 'Samsung', 'KV80C', 80, '4K', 1600.00, 3, 2023, TRUE, 'Tizen', 'LED');

INSERT INTO televisions (catalog_number, brand, model, screen_size, resolution, price, stock_quantity, release_year, smart_tv, os, panel_type)
VALUES ('TV3', 'Hisense', 'R76DC', 90, '8K', 2200.00, 10, 2025, FALSE, 'Android', 'OLED');
